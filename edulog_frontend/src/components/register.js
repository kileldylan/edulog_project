...
import { registerUser } from "../utils/api"; // Import the function
...
function Register() {
  ...
  const handleRegister = async () => {
    try {
      ...
      if (userType === 'student') {
          dataToSend.student_id = userDetails.student_id.trim(); 
      }
        console.log("Sending registration request:", dataToSend); // Debugging
